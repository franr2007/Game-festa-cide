...
public class PantallaBienvenida extends JFrame {
    ...
    private void crearElementos() {
        ...
        imgFantasma1 = Juego.escalarImg(new ImageIcon(getClass().getResource("/recursos/fantasma4.png")));
        imgFantasma2 = Juego.escalarImg(new ImageIcon(getClass().getResource("/recursos/fantasmaV.png")));
